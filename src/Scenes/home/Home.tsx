      ...
      >
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis saepe corporis dignissimos totam magni minima laboriosam voluptatem deserunt vitae error.
            </p>
          </motion.div>
          {/* Action  */}
        ...
        <div className="h-[150px] w-full bg-primary-100 py-10">
          <div className="mx-auto w-5/6">
            <div className="flex w-3/5 items-center justify-between gap-8">
              <img src={SponserForbes} alt="sponser-forbes-img" />
              <img src={SponserRedBull} alt="sponser-redbull-img" />
              <img src={SponserFortune} alt="sponser-fortune-img" />
            </div>
          </div>
        </div>
      )}
